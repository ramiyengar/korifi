...
// TODO: replace the other helper with this
func createOrgWithCleanup2(ctx context.Context, name string) *workloadsv1alpha1.CFOrg {
	guid := uuid.NewString()
...
// TODO: replace this with the new version
